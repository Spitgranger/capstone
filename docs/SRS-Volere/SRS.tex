...
\begin{enumerate} [{}1.]
  \item The application should not create redundant workload for tasks already 
  carried out by existing solutions.
  \item 
\end{enumerate}
\subsection{Effects on the Installed Systems}
\begin{enumerate} [{}1.]
  \item The application should not affect the system it is being run on other 
  than taking in the required inputs and providing the appropriate outputs.
  \item The application should not affect the systems it is interfacing with
   other than retrieving
