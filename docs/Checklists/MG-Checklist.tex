...
\begin{itemize}
  ...
  \item Module Decomposition
    \begin{todolist}
    \item One module one secret (unless an explicit exception is
        made, with a good
    ...
    \item Each Software Decision Hiding module is used by at least one
      ...
      provided)
    \item Uses relation is not confused with a data flow chart. If
      you can imagine
      an ``import B'' statement in the code for module A, then module
      A uses module
      B.
