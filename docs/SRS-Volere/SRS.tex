...
\begin{enumerate} [{C-SCH}1.]
  \item A requirement [Link requirement number here in future] is to integrate
  with the Infor work order management system the city intends on using however,
  this system will not be available until February 2025, so no testing can be
  done on this system until then.
