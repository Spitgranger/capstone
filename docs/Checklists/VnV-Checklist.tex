...
\begin{itemize}
  ...
  \item Grammar, spelling, presentation
    ...
    \item No grammar mistakes (review, ask someone else to review (at
          least a few
      sections))
  ...
  \item Overall qualities of documentation
    ...
    \item Specific performance measuring tools listed (like Valgrind), if
      appropriate
    \item Traceability between test cases and requirements is
      summarized (likely in
      a table)
    \end{todolist}
