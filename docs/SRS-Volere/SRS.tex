...
\begin{enumerate} [{OE-WE}1.]
  \item Application should be functional on Mobile and Desktop web browser environments.
  \item Application should be able to run on any device with a modern web browser.
\end{enumerate}
\subsection{Requirements for Interfacing with Adjacent Systems}
\begin{enumerate} [{OE-IAS}1.]
  \item Application should integrate with existing SharePoint repositories.
  \item Application should not create redundant workload by sharing duplicate features
...
\begin{enumerate} [{OE-REL}1.]
  \item A change-log should be generated with every release documenting changes in
